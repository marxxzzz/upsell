...
export default async function handler(req, res) {
  ...
  const buckpayPayload = {
    ...
    product: { id: String(body.product_key || config.productKey), name: 'Taxa de Entrega' },
    offer: { id: `${body.product_key || config.productKey}-offer`, name: 'Taxa de Entrega', quantity: 1 },
    tracking: {
